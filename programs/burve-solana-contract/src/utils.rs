...
pub const PROJECT_METADATA_SEED: &[u8] = b"project-metadata";
pub const MINT_ACCOUNT_SEED: &[u8] = b"token-mint-account";
pub const MAX_TAX_RATE_DENOMINATOR: u64 = 10000;

#[error_code]
pub enum Errors {
    #[msg("SignerIsNotAdmin")]
    SignerIsNotAdmin,
    #[msg("TaxRateNotValid")]
    TaxRateNotValid,
}
